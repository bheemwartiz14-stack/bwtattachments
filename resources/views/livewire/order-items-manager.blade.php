            ...
            <table class="w-full text-sm table-fixed">
                <thead>
                    <tr class="border-b border-slate-200 bg-slate-50/70 dark:border-neutral-800 dark:bg-neutral-900/50">
                        ...
                        <th class="px-3 py-3 text-right text-xs font-semibold uppercase tracking-wider text-slate-500" style="width:15%">Total</th>
                    ...
                    @forelse($items as $index => $item)
                        ...
                        <tr class="transition-colors hover:bg-slate-50 dark:hover:bg-neutral-900/50">
                            <td class="px-3 py-3 text-left align-middle">
                                <span class="text-xs font-mono font-semibold text-slate-700 dark:text-neutral-300">{{ $item['product_code'] ?? '—' }}</span>
                            </td>
                            <td class="px-3 py-3 text-left align-middle">
