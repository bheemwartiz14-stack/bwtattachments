<x-layouts.app>
    ...
    <div class="space-y-6">
        <x-ui.hero title="Admin Dashboard" subtitle="Full system management overview">
            <x-slot:actions>
                <span class="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3.5 py-1.5 text-xs font-semibold text-white ring-1 ring-white/20">Super Admin</span>
            </x-slot:actions>
        </x-ui.hero>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <a href="{{ route('admin.products.index') }}" class="flex items-center gap-4 rounded-xl border border-slate-100 p-4 transition-all hover:border-emerald-200 hover:bg-emerald-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-emerald-800 dark:hover:bg-emerald-900/20">
                    ...
                    <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-4 rounded-xl border border-slate-100 p-4 transition-all hover:border-blue-200 hover:bg-blue-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-blue-800 dark:hover:bg-blue-900/20">
                    ...
                    <a href="{{ route('admin.subcategories.index') }}" class="flex items-center gap-4 rounded-xl border border-slate-100 p-4 transition-all hover:border-indigo-200 hover:bg-indigo-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-indigo-800 dark:hover:bg-indigo-900/20">
                    ...
                    <a href="{{ route('admin.connections.index') }}" class="flex items-center gap-4 rounded-xl border border-slate-100 p-4 transition-all hover:border-teal-200 hover:bg-teal-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-teal-800 dark:hover:bg-teal-900/20">
                    ...
                    <a href="{{ route('admin.wholesale-client-users.index') }}" class="flex items-center gap-4 rounded-xl border border-slate-100 p-4 transition-all hover:border-amber-200 hover:bg-amber-50 hover:shadow-sm dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-amber-800 dark:hover:bg-amber-900/20">
                ...
                @if(isset($recentProducts) && $recentProducts->count())
                    <div class="space-y-2">
                        @foreach($recentProducts as $product)
                            <a href="{{ route('admin.products.show', $product) }}" class="flex items-center justify-between rounded-xl p-3 transition-colors hover:bg-slate-50 dark:hover:bg-neutral-800/50">
