        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1 min-w-0 space-y-8">
                @if($activeTab === 'personal')
                    ...
                    <div>
                        <div class="mb-6">
                            <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-neutral-100">Personal Information</h1>
                ...
                @elseif($activeTab === 'company')
                    ...
                    <div>
                        <div class="mb-6">
                            <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-neutral-100">Company Details</h1>
                                ...
                                @if($user->hasRole('Wholesale Client'))
                                    <div class="flex flex-col sm:flex-row items-start gap-6">
                                        @if($wholesaleClientLogoUrl ?? null)
                                            <div class="shrink-0">
                                                <img src="{{ $wholesaleClientLogoUrl }}" alt="Company Logo" class="h-24 w-24 rounded-xl border border-slate-200 object-contain p-3 dark:border-neutral-700">
                                            </div>
                                        @else
                                        ...
                                        <div class="min-w-0 flex-1 space-y-3">
                                            <div>
                                                ...
                                                <p class="text-base font-semibold text-slate-900 dark:text-white mt-0.5">{{ $wholesaleClientName ?? 'N/A' }}</p>
                                            </div>
                                            <div>
                                ...
                                @if($user->hasRole('Retailer'))
                                    <div class="flex flex-col sm:flex-row items-start gap-6">
                                        @if($retailerClientLogoUrl ?? null)
                                            <div class="shrink-0">
                                                <img src="{{ $retailerClientLogoUrl }}" alt="Company Logo" class="h-24 w-24 rounded-xl border border-slate-200 object-contain p-3 dark:border-neutral-700">
                                            </div>
                                        @else
                                            <div class="shrink-0 flex h-24 w-24 items-center justify-center rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 dark:border-neutral-700 dark:bg-neutral-900">
                                                <svg class="h-8 w-8 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21" /></svg>
                                        ...
                                        <div class="min-w-0 flex-1 space-y-3">
                                            <div>
                                                <p class="text-xs font-medium uppercase tracking-wide text-slate-400 dark:text-neutral-500">Company Name</p>
                                                <p class="text-base font-semibold text-slate-900 dark:text-white mt-0.5">{{ $retailerClientName ?? 'N/A' }}</p>
                                            </div>
                                            <div>
                ...
                @elseif($activeTab === 'security')
                    ...
                    <div>
                        <div class="mb-6">
                            <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-neutral-100">Security</h1>
