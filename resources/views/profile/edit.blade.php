...
<x-layouts.app>
    ...
    @if(session('success'))
        <div class="rounded-xl border border-emerald-200 bg-emerald-50 px-5 py-3.5 text-sm font-medium text-emerald-800 dark:border-emerald-900/50 dark:bg-emerald-900/30 dark:text-emerald-300">
            {{ session('success') }}
        </div>
    @endif
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            <div class="px-8 py-5 border-b border-slate-100 dark:border-neutral-800">
                <h2 class="text-base font-semibold text-slate-900 dark:text-white">Personal Information</h2>
                <p class="text-xs text-slate-500 dark:text-neutral-400 mt-0.5">Update your name, phone number, and profile photo</p>
            </div>
            <form method="POST" action="{{ route($prefix . '.profile.update') }}" class="p-8">
                ...
                <div class="space-y-8">
                        ...
                        <div class="shrink-0">
                            <div class="relative">
                                ...
                                <label for="avatar_input"
                                    class="absolute bottom-0 right-0 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-white shadow-md ring-2 ring-white transition-colors hover:bg-slate-50 dark:bg-neutral-800 dark:ring-neutral-900 dark:hover:bg-neutral-700">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-medium text-slate-700 dark:text-neutral-300 mb-1.5">Phone</label>
                    ...
                    <div class="flex items-center justify-end gap-3 border-t border-slate-100 pt-6 dark:border-neutral-800">
                        <button type="submit"
                            class="inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-950">
                            Save Changes
                        </button>
                    </div>
                </div>
        ...
        @if($user->hasRole('Wholesale Client') || $user->hasRole('Retailer'))
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
                <div class="px-8 py-5 border-b border-slate-100 dark:border-neutral-800">
                    ...
                    <p class="text-xs text-slate-500 dark:text-neutral-400 mt-0.5">Your registered business information</p>
                </div>
                <div class="p-8">
                    @if($user->hasRole('Wholesale Client'))
                        <div class="flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div class="min-w-0 flex-1 space-y-3">
                                ...
                                <div>
                                    <span class="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-medium text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">Wholesale Client</span>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($user->hasRole('Retailer'))
                        <div class="flex flex-col sm:flex-row items-start gap-6">
                            ...
                            <div class="min-w-0 flex-1 space-y-3">
                                ...
                                <div>
                                    <span class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">Retailer</span>
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            <div class="px-8 py-5 border-b border-slate-100 dark:border-neutral-800">
                ...
                <p class="text-xs text-slate-500 dark:text-neutral-400 mt-0.5">Update your password to keep your account secure</p>
            </div>
            <form method="POST" action="{{ route($prefix . '.profile.password') }}" class="p-8">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-slate-700 dark:text-neutral-300 mb-1.5">Confirm Password</label>
