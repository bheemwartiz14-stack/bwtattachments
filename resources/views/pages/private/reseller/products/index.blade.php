<x-layouts.app>
    ...
    <div class="space-y-6">
        ...
        <form method="GET" action="{{ route('reseller.products.index') }}"
                            ...
                            <tr class="transition-colors hover:bg-slate-50/80 dark:hover:bg-neutral-800/30">
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="{{ route('reseller.products.show', $product) }}" wire:navigate
                                ...
                                <td class="px-6 py-4 text-right">
                                    @auth
                                        <button type="button"
                                            ...
                                            data-favorited="{{ $product->is_favorite ? 'true' : 'false' }}"
                                            ...
                                            <svg class="h-4 w-4 transition-colors {{ $product->is_favorite ? 'text-red-500 fill-red-500' : 'text-slate-500 dark:text-neutral-400' }}"
                                                viewBox="0 0 24 24" fill="{{ $product->is_favorite ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                                            </svg>
                                        </button>
                                    @endauth
                                    <a href="{{ route('reseller.products.show', $product) }}" title="View"
