<x-layouts.app>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Products', 'url' => route('reseller.products.index')],
            ...
            <div class="relative flex flex-col md:flex-row">
                ...
                <div class="flex-1 p-8 flex flex-col justify-between">
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        <a href="{{ route('reseller.products.index') }}" wire:navigate class="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-5 py-2.5 text-sm font-medium text-white/80 shadow-sm transition-all hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/30">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                      <p class="text-xs font-medium text-slate-400 uppercase tracking-wide">
                        ...
                        <p class="mt-1.5 text-2xl font-bold text-slate-900 dark:text-white">{{ config('app.currency_symbol') }}{{ number_format($product->price, 2) }}</p>
                    </div>
                    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
