...
<x-layouts.app>
    ...
    <x-breadcrumb :items="[
        ...
        ['label' => 'Customer Users', 'url' => route('client.reseller-users.index')],
        ['label' => $isEdit ? 'Edit' : 'New'],
    ]" />
    <div class="space-y-4">
        <x-ui.hero title="{{ $isEdit ? 'Edit' : 'Add' }} Customer"
            subtitle="{{ $isEdit ? 'Update Customer' : 'Create a new Customer' }}">
            <x-slot:icon>
        ...
        <form
            action="{{ $isEdit ? route('reseller.customer-users.update', $user) : route('reseller.customer-users.store') }}"
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-3">
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <span
                                            class="font-semibold text-emerald-800 dark:text-emerald-300">{{ $userRole ?? 'Customer' }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div
                ...
                <div class="p-8">
                    <x-forms.image-dropzone name="customer_logo" :existingImageUrl="$logoUrl" label="Customer Logo"
