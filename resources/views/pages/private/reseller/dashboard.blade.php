<x-layouts.app>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3">
            <x-stat-card label="Products" :value="number_format($stats['total_products'])" :url="route('reseller.products.index')" iconBg="bg-emerald-50 dark:bg-emerald-900/30"
            ...
            <x-stat-card label="Total Orders" :value="$stats['total_orders']" :url="route('reseller.orders.index')" iconBg="bg-blue-50 dark:bg-blue-900/30"
            ...
            <x-stat-card label="Quotations" :value="$stats['quotations']" :url="route('reseller.quotations.index')" iconBg="bg-amber-50 dark:bg-amber-900/30"
