<x-layouts.app>
    ...
    <div class="mb-6">
        <x-ui.hero title="New Quotation" icon="heroicon-o-document-plus">
            <x-slot:actions>
    ...
    <form id="quotation-form" action="{{ route('reseller.quotations.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-6 py-4 dark:border-neutral-800">
                    ...
                    <div>
                        <h2 class="text-base font-semibold text-slate-900 dark:text-white">Select Customer</h2>
                    </div>
                </div>
                <div class="p-6">
