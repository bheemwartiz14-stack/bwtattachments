<x-layouts.app>
    ...
    <x-breadcrumb :items="[['label' => 'Retailer Portal', 'url' => route('retailer.dashboard')], ['label' => 'Products']]" />
    <div class="space-y-6">
        ...
        <form method="GET" action="{{ route('retailer.products.index') }}"
            ...
            <div class="flex flex-wrap items-center justify-between gap-3 mt-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('retailer.products.index') }}" wire:navigate
                            ...
                            <tr class="transition-colors hover:bg-slate-50/80 dark:hover:bg-neutral-800/30">
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="{{ route('retailer.products.show', $product) }}" wire:navigate
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('retailer.products.show', $product) }}" title="View"
