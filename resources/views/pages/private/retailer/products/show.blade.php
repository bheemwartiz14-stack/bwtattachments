            ...
            <div class="relative flex flex-col md:flex-row">
                ...
                <div class="flex-1 p-8 flex flex-col justify-between">
                    ...
                    <div class="mt-6 flex items-center gap-3">
                        <a href="{{ route('retailer.products.index') }}" wire:navigate class="inline-flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-5 py-2.5 text-sm font-medium text-white/80 shadow-sm transition-all hover:bg-white/20 focus:outline-none focus:ring-2 focus:ring-white/30">
