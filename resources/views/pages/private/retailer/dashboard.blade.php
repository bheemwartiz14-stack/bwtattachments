    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
                <div class="flex items-start justify-between">
                    <div>
                        <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-neutral-100">Welcome back, {{ $user->name ?? 'Retailer' }}</h1>
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Here's what's happening with your account today.</p>
                    </div>
                    <span class="inline-flex items-center rounded-full bg-emerald-100 px-3 py-1 text-xs font-medium text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-300">Retailer</span>
                </div>
        ...
        <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            ...
            <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
                <a href="{{ route('retailer.products.index') }}" wire:navigate class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-emerald-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-emerald-800">
                ...
                <a href="{{ route('retailer.quotations.create') }}" wire:navigate class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-blue-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-blue-800">
                ...
                <a href="{{ route('retailer.quotations.index', ['status' => 'draft']) }}" wire:navigate class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-amber-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-amber-800">
                ...
                <a href="{{ route('retailer.quotations.index') }}" wire:navigate class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-purple-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-purple-800">
        ...
        <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('retailer.quotations.index') }}" wire:navigate class="text-sm font-medium text-slate-600 hover:text-slate-800 dark:text-neutral-400 dark:hover:text-neutral-200">View all</a>
            </div>
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-neutral-800">
                        @forelse($recentQuotations ?? [] as $quotation)
                            <tr class="transition-colors hover:bg-slate-50 dark:hover:bg-neutral-900/50">
                                <td class="px-4 py-4">
                                    <a href="{{ route('retailer.quotations.show', $quotation) }}"  wire:navigate class="font-mono text-sm font-medium text-slate-600 hover:text-slate-800 dark:text-neutral-400">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-12 text-center">
                                    ...
                                    <a href="{{ route('retailer.quotations.create') }}" wire:navigate class="mt-3 inline-flex items-center justify-center gap-2 rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-slate-700 dark:bg-neutral-800 dark:text-white dark:hover:bg-neutral-700">Create your first quotation</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
