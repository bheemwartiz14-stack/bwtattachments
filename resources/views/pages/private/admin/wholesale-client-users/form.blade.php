    ...
    <div class="space-y-6">
        ...
        <form
            ...
            <div
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        <x-forms.input name="wholesale_company_name" label="Company Name" placeholder="Acme Corp Ltd"
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-5 dark:border-neutral-800">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-neutral-400">Login credentials and personal
                            information</p>
                    </div>
                </div>
                <div class="p-8">
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-5 dark:border-neutral-800">
                    <div
                        class="flex h-9 w-9 items-center justify-center rounded-lg bg-purple-50 dark:bg-purple-900/30">
