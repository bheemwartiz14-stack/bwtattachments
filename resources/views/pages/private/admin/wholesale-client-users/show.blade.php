<x-layouts.app>
    ...
    <x-breadcrumb :items="[['label' => 'Admin Poral', 'url' => route('admin.dashboard')], ['label' => 'Manage Wholeseller', 'url' => route('admin.wholeseller.index')], ['label' => $user->name]]" />
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    <div class="px-6 py-5">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2">
                            @foreach([
                                ['Company Name', $meta['wholesale_company_name'] ?? '—', true],
                    ...
                    <div class="px-6 py-5">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2">
                            ...
                            <div class="md:col-span-2">
                                @php
                                $decryptedPass = \App\Helpers\PasswordHelper::isEncrypted($meta['plain_password'])? \App\Helpers\PasswordHelper::decrypt($meta['plain_password']): $meta['plain_password'];
                                @endphp
                                <x-forms.password
                                    name="password"
                                    label="Password"
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    @if($logoUrl)
                        <img src="{{ $logoUrl }}" alt="{{ $meta['wholesale_company_name'] ?? 'Logo' }}" class="max-h-32 w-full rounded-xl border border-slate-100 object-contain p-4 dark:border-neutral-700">
                    @else
