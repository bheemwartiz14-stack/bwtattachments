<x-layouts.app>
    <x-slot:title>{{ $user->name }} - Retailer Client - BWT</x-slot:title>
    <x-breadcrumb :items="[
        ['label' => 'Dashboard', 'url' => route('client.dashboard')],
        ['label' => 'Retailer Clients', 'url' => route('client.retailer-users.index')],
        ['label' => $user->name],
    ]" />
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-neutral-400">
                            {{ $meta['company_name'] ?? 'No company' }} &middot; {{ $user->email }}</p>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div
                    ...
                    <div class="px-6 py-5">
                        <dl class="grid grid-cols-1 gap-x-8 gap-y-5 sm:grid-cols-2">
                            @foreach ([['Company Name', $meta['company_name'] ?? '—', true], ['VAT Number', $meta['vat_number'] ?? '—', true], ['Address', $meta['address'] ?? '—', false], ['Postal Code', $meta['postal_code'] ?? '—', false], ['City', $meta['city'] ?? '—', false], ['Country', $meta['country'] ?? '—', false]] as [$label, $val, $semibold])
                                <div>
                                    <dt
            ...
            <div class="space-y-6">
                ...
                <div
                    ...
                    @if ($logoUrl)
                        <img src="{{ $logoUrl }}" alt="{{ $meta['company_name'] ?? 'Logo' }}"
