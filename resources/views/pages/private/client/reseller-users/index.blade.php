<x-layouts.app>
    <x-slot:title>Resellers Clients - BWT</x-slot:title>
    <x-breadcrumb :items="[['label' => 'Client Portal', 'url' => route('client.dashboard')], ['label' => 'Resellers Clients']]" />

    <div class="space-y-6">
        <x-ui.hero title="Resellers Clients" subtitle="Manage your resellers client user accounts">
            <x-slot:actions>
