...
<x-layouts.app>
    ...
    <div class="space-y-4">
        <x-ui.hero title="{{ $isEdit ? 'Edit' : 'Add' }} Reseller"
            subtitle="{{ $isEdit ? 'Update Reseller' : 'Create Reseller' }}">
            <x-slot:icon>
        ...
        <form
            action="{{ $isEdit ? route('client.reseller-users.update', $user) : route('client.reseller-users.store') }}"
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-5 dark:border-neutral-800">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-neutral-400">Business information and registration
                        </p>
                    </div>
                </div>
                <div class="p-8">
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-6 dark:border-neutral-800">
                    <div class="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 dark:bg-neutral-800">
                        <svg class="h-5 w-5 text-slate-600 dark:text-neutral-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        ...
                        <x-forms.email name="email" label="Email Address" placeholder="reseller@company.com"
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-6 dark:border-neutral-800">
                    ...
                    <h2 class="text-base font-semibold text-slate-900 dark:text-white">Reseller Profile</h2>
                </div>
                <div class="p-8">
                    <x-forms.image-dropzone name="retailer_client_logo" :existingImageUrl="$logoUrl"
                        label="Reseller Client Logo" accept="image/jpeg,image/png,image/webp"
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-6 dark:border-neutral-800">
                    ...
                    <h2 class="text-base font-semibold text-slate-900 dark:text-white">Reseller Commission Settings
                    </h2>
                </div>
                <div class="p-8">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        <x-forms.input name="commission_percentage" label="Commission Percentage (%)" type="number"
                            ...
                            hint="Default commission percentage applied to product pricing for this reseller." />
                    </div>
                </div>
            </div>

            <div
                class="flex items-center justify-end gap-3 rounded-2xl border border-slate-200 bg-white px-8 py-5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                <a href="{{ route('client.reseller-users.index') }}" wire:navigate
                ...
                <button type="submit"
                    class="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-bold text-white shadow-sm transition-all hover:bg-slate-800 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 dark:bg-emerald-600 dark:hover:bg-emerald-700">
