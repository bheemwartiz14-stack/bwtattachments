...
<x-layouts.app>
    ...
    <x-breadcrumb :items="[['label' => 'Dashboard', 'url' => route('client.dashboard')], ['label' => 'Resellers', 'url' => route('client.reseller-users.index')], ['label' => $isEdit ? 'Edit' : 'New']]" />

    <div class="space-y-4">
        <x-ui.hero title="{{ $isEdit ? 'Edit' : 'Add' }} Reseller" subtitle="{{ $isEdit ? 'Update a new Reseller' : 'Create a new Reseller' }}">
            <x-slot:icon>
