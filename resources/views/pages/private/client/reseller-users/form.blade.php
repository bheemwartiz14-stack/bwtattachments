        ...
        <form
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-8 py-6 dark:border-neutral-800">
                    ...
                    <h2 class="text-base font-semibold text-slate-900 dark:text-white">Reseller Margin Settings
                    </h2>
                </div>
                <div class="p-8">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 lg:grid-cols-2">
                        <x-forms.input name="commission_percentage" label="Margin Percentage (%)" type="number"
                            ...
                            hint="Default Margin percentage applied to product pricing for this reseller." />
                    </div>
                </div>
            </div>
