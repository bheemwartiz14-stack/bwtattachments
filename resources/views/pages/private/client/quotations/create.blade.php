<x-layouts.app>
    ...
    <div class="mb-6">
        <x-ui.hero title="New Quotation" icon="heroicon-o-document-text">
            <x-slot:actions>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div
                ...
                <div class="flex items-center gap-3 border-b border-slate-100 px-6 py-4 dark:border-neutral-800">
                    ...
                    <div>
                        <h2 class="text-base font-semibold text-slate-900 dark:text-white">Select Reseller</h2>
                    </div>
                </div>
                <div class="p-6">
                    @if ($resellers->isEmpty())
                        <div
                            ...
                            <p class="text-sm font-medium text-slate-500 dark:text-neutral-400">No reseller found</p>
                        </div>
                    @else
                        <div class="space-y-4">
                            <livewire:customer-select :selectedId="old('reseller_id')" :users="$resellers" :placeholder="'Search for Reseller'" />
                        </div>
                    @endif
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-neutral-300 mb-1">Margin
                                (%)</label>
                            <div
                                class="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5 text-sm text-slate-700 dark:border-neutral-700 dark:bg-neutral-800/50 dark:text-neutral-300">
                                <span id="margin_percentage">0.00%</span>
                                <svg class="ml-auto h-4 w-4 shrink-0 text-slate-400 dark:text-neutral-500"
