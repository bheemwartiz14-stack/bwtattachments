          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="space-y-4 text-sm text-gray-600">
              <div class="flex items-start gap-3">
                ...
                <span>{{ $siteSettings['contact_email'] ?? 'info@bigworktools.com' }}</span>
              </div>
              <div class="flex items-start gap-3">
              ...
              <div class="flex items-start gap-3">
                ...
                <span>{!! nl2br(e($siteSettings['site_address'] ?? '123 Business Ave, Suite 100, New York, NY 10001, USA')) !!}</span>
              </div>
            </div>
          </div>
