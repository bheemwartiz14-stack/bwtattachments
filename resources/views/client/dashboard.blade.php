<x-layouts.app>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-neutral-100">Welcome back, {{ auth()->user()->name ?? 'Client' }}</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <x-stat-card label="Pending Quotations" :value="$stats['pending_quotations'] ?? 0" trend="up" trendText="Awaiting response"
                iconBg="bg-slate-100 dark:bg-neutral-900"
                icon='<svg class="w-6 h-6 text-slate-700 dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>' />
            ...
            <x-stat-card label="Saved Products" value="0" trend="up" trendText="In quote list"
                iconBg="bg-slate-100 dark:bg-neutral-900"
                icon='<svg class="w-6 h-6 text-slate-700 dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" /></svg>' />
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-4">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('client.quotations.index') }}" class="text-sm font-medium text-slate-600 hover:text-slate-800">View all</a>
                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    <a href="{{ route('client.products.index') }}" class="flex items-center gap-4 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-colors hover:bg-slate-50 dark:border-neutral-800 dark:bg-neutral-950 dark:hover:bg-neutral-900">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-400 dark:text-neutral-500">View our full product catalog</p>
                        </div>
                    ...
                    <a href="{{ route('client.quotations.create') }}" class="flex items-center gap-4 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-colors hover:bg-slate-50 dark:border-neutral-800 dark:bg-neutral-950 dark:hover:bg-neutral-900">
                    ...
                    <a href="{{ route('client.profile.edit') }}" class="flex items-center gap-4 rounded-2xl border border-slate-100 bg-white p-4 shadow-sm transition-colors hover:bg-slate-50 dark:border-neutral-800 dark:bg-neutral-950 dark:hover:bg-neutral-900">
                        <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-100 dark:bg-neutral-900">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-400 dark:text-neutral-500">Manage your account settings</p>
                        </div>
                        <svg class="w-5 h-5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                    </a>
                </div>
