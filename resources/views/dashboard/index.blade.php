<x-layouts.app>
    ...
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-950 dark:text-slate-100">Dashboard</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div class="rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <div class="flex items-center gap-4 px-6 py-3.5 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800/50 transition-colors">
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-100 dark:bg-slate-800 text-gray-400 dark:text-gray-500">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-black dark:text-gray-100">{{ $product }}</p>
                            <p class="text-xs text-gray-400 dark:text-gray-500">BKT-00{{ $i + 1 }} &middot; Added {{ $i + 1 }}d ago</p>
                        </div>
            ...
            <div class="rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                ...
                <div class="divide-y divide-slate-100 dark:divide-slate-700">
                    ...
                    <div class="flex items-center gap-4 px-6 py-3.5 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800/50 transition-colors">
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-black dark:text-gray-100">{{ $q['id'] }}</p>
                            <p class="text-xs text-gray-400 dark:text-gray-500">{{ $q['client'] }}</p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-semibold text-black dark:text-gray-100">{{ $q['total'] }}</p>
                            @php
        ...
        <div class="rounded-2xl border border-slate-100 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
            ...
            <div class="p-6 grid grid-cols-2 sm:grid-cols-4 gap-4">
                <a href="#" class="flex flex-col items-center gap-3 p-4 rounded-xl border border-slate-100 dark:border-slate-700 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-black dark:text-gray-100">Add Product</span>
                </a>
                <a href="#" class="flex flex-col items-center gap-3 p-4 rounded-xl border border-slate-100 dark:border-slate-700 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800 transition-colors group">
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 dark:bg-emerald-900/30 group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/50 transition-colors">
                        <svg class="w-6 h-6 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                    </div>
                    <span class="text-sm font-medium text-black dark:text-gray-100">Add Client</span>
                </a>
                <a href="#" class="flex flex-col items-center gap-3 p-4 rounded-xl border border-slate-100 dark:border-slate-700 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-black dark:text-gray-100">New Quotation</span>
                </a>
                <a href="#" class="flex flex-col items-center gap-3 p-4 rounded-xl border border-slate-100 dark:border-slate-700 hover:bg-rose-50 dark:bg-slate-800/50 dark:hover:bg-slate-800 transition-colors group">
                    ...
                    <span class="text-sm font-medium text-black dark:text-gray-100">Upload Media</span>
                </a>
            </div>
        </div>
    </div>
