@php
    ...
    if ($userType === 'Wholesaler') {
        ...
        $introText = 'wholesaler account';
        $accessButton = 'Access Your Wholesaler Account &rarr;';
        ...
        $introText = 'reseller account';
        $accessButton = 'Access Your Reseller Account &rarr;';
    } else {
        $clientName = $meta['company_name'] ?? ($meta['customer_client_name'] ?? 'Customer Client');
        $accountLabel = 'Customer';
        $title = 'Customer Account';
        $introText = 'customer account';
        $accessButton = 'Access Your Customer Account &rarr;';
    }
...
<tr>
    <td class="fluid-padding" style="padding:36px 40px 6px 40px;">
        ...
        <p
            ...
            We're pleased to let you know your {{ $introText }} has been successfully created — including access to
            our full product catalog, wholesale pricing, and business services.
        </p>
    </td>
</tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td class="row-label"
                                ...
                                Website</td>
                            <td class="row-value"
                                style="padding:8px 0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13.5px; font-weight:600; text-align:right; vertical-align:top; word-break:break-all;">
                                @if (!empty($meta['website']))
                                    <a href="{{ $meta['website'] }}"
                                        style="color:#4f46e5; text-decoration:none;">{{ $meta['website'] }}</a>
                                @else
                                    —
                                @endif
                            </td>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            <td class="row-label"
                                ...
                                Email</td>
                            <td class="row-value"
                                style="padding:8px 0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13.5px; font-weight:600; color:#1f2937; text-align:right; vertical-align:top; word-break:break-all;">
                                {{ $user->email }}</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="border-top:1px solid #eef0f4; font-size:1px; line-height:1px;">
                        ...
                        <tr>
                            <td class="row-label"
                                style="padding:8px 0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13.5px; color:#9ca3af; vertical-align:middle;">
                                Type</td>
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tr>
                                        <td style="background-color:#111827; border-radius:6px; padding:4px 12px;">
                                            <span
                                                style="font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:12px; font-weight:700; color:#ffffff;">{{ $accountLabel }}</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
...
<tr>
    <td class="fluid-padding" style="padding:16px 40px 6px 40px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
            style="background-color:#111827; border-radius:14px;">
            <tr>
                <td class="details-cell" style="padding:22px 24px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0"
                        style="margin-bottom:16px;">
                        <tr>
                            <td
                                style="width:26px; height:26px; background-color:#1e293b; border-radius:8px; text-align:center; vertical-align:middle;">
                                <span style="font-size:13px; line-height:26px;">🔑</span>
                            </td>
                            <td
                                style="padding-left:9px; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13px; font-weight:700; letter-spacing:0.3px; color:#ffffff;">
                                Login Credentials
                            </td>
                        </tr>
                    </table>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            <td
                                ...
                                Username</td>
                            <td
                                style="padding:8px 0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13.5px; font-weight:600; color:#ffffff; text-align:right; vertical-align:top;">
                                {{ $user->username }}</td>
                        </tr>
                        <tr>
                            <td colspan="2" style="border-top:1px solid #374151; font-size:1px; line-height:1px;">
                                &nbsp;</td>
                        </tr>
                        <tr>
                            <td
            ...
            <tr>
                <td align="center" style="border-radius:10px; background-color:#111827;">
                    <a href="{{ $loginUrl }}" target="_blank"
                        style="display:inline-block; width:100%; padding:14px 32px; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:15px; font-weight:700; color:#ffffff; text-decoration:none; border-radius:10px; box-sizing:border-box; letter-spacing:-0.2px;">
                        Access Your {{ $accountLabel }} Account &rarr;
                    </a>
                </td>
            </tr>
        </table>
                ...
                <td style="padding:16px 18px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td>
                                <p
                                    style="margin:0 0 4px 0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13.5px; font-weight:700; color:#92400e;">
                                    Security Notice
                                </p>
                                <p
                                    style="margin:0; font-family:'Segoe UI', Roboto, Helvetica, Arial, sans-serif; font-size:13px; line-height:20px; color:#78350f;">
                                    For your account security, please change your password after your first login. Do
