@php
    $logoUrl = $user->userMeta?->getFirstMediaUrl('retailer_client_logo');
    $clientName = $user->userMeta?->metadata['retailer_client_name'] ?? 'Retailer Client';
@endphp
...
<div class="wrapper">
    ...
    <div class="card">
        ...
        <div class="header">
            ...
            <h1>You're in.</h1>
            <p class="subtitle">Your retailer account is ready to go</p>
        </div>
