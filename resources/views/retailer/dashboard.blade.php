    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            ...
            <div class="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4">
                <a href="{{ route('retailer.products.index') }}" class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-emerald-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-emerald-800">
                ...
                <a href="{{ route('retailer.quotations.create') }}" class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-blue-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-blue-800">
                ...
                <a href="{{ route('retailer.quotations.index', ['status' => 'draft']) }}" class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-amber-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-amber-800">
                ...
                <a href="{{ route('retailer.quotations.index') }}" class="group rounded-xl border border-slate-100 bg-white p-4 text-center transition-all hover:border-purple-200 hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950 dark:hover:border-purple-800">
        ...
        <div class="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('retailer.quotations.index') }}" class="text-sm font-medium text-slate-600 hover:text-slate-800 dark:text-neutral-400 dark:hover:text-neutral-200">View all</a>
            </div>
