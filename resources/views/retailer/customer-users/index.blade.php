<x-layouts.app>
    ...
    <div class="space-y-6">
        <x-ui.hero title="Customers" subtitle="Manage your Customers user accounts">
            <x-slot:actions>
                <a href="{{ route('retailer.customer-users.create') }}"
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
            <div class="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between border-b border-slate-100 dark:border-neutral-800">
                <form method="GET" action="{{ route('retailer.customer-users.index') }}" class="flex flex-1 items-center gap-3">
                    ...
                    @if(request('search'))
                        <a href="{{ route('retailer.customer-users.index') }}" class="text-sm font-medium text-slate-500 hover:text-slate-700 dark:text-neutral-400">Clear</a>
                    @endif
                </form>
            </div>
                            ...
                            <tr class="transition-colors hover:bg-slate-50/80 dark:hover:bg-neutral-800/30">
                                <td class="px-5 py-4">
                                    <div class="flex items-center gap-3">
                                          <a href="{{ route('retailer.customer-users.show', $user) }}" title="View"
                                        ...
                                        <a href="{{ route('retailer.customer-users.show', $user) }}"
                                ...
                                <td class="px-5 py-4 text-right">
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            <a href="{{ route('retailer.customer-users.edit', $user) }}" title="Edit"
                                                class="inline-flex items-center justify-center rounded-lg p-2 text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500 dark:text-neutral-400 dark:hover:bg-neutral-800 dark:hover:text-white">
