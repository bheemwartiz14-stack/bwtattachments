...
use App\Http\Requests\Reseller\Quotations\StoreQuotationRequest;
...
class CustomerQuotationController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('pages.private.reseller.quotations.index', compact('quotations'));
    }
    ...
    public function create(): View
    {
        ...
        return view('pages.private.reseller.quotations.create', compact('resellers', 'quotationNumber', 'productId', 'cartIds', 'cartItems'));
    }
    ...
    public function store(StoreQuotationRequest $request): RedirectResponse
    {
        ...
        if ($request->input('action') === 'preview') {
            ...
            return redirect()->route('reseller.quotations.preview', $quotation->id)->with('success', 'Quotation created and PDF generated successfully.');
        }
        ...
        return redirect()->route('reseller.quotations.show', $quotation->id)
    ...
    public function show(string $id): View
    {
        ...
        return view('pages.private.reseller.quotations.show', compact('quotation'));
    }
    ...
    public function destroy(string $id): RedirectResponse
    {
        ...
        return redirect()
            ->route('reseller.quotations.index')
