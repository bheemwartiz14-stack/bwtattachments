...
class ProfileController extends Controller
{
    ...
    public function edit(): View
    {
        ...
        $viewData['prefix'] = 'customer';
        $viewData['breadcrumbLabel'] = 'Customer Portal';
        $viewData['breadcrumbRoute'] = 'customer.dashboard';
        $viewData['hasCompany'] = true;
        $viewData['roleLabel'] = 'Customer';
        $viewData['commissionPercentage'] = $user->userMargin?->margin_value;


        return view('pages.private.customer.profile.edit', $viewData);
    }
    ...
    public function update(UpdateProfileRequest $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('customer.profile.edit', ['tab' => 'personal'])
    ...
    public function deleteLogo(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('customer.profile.edit', ['tab' => 'company'])
