...
class RetailerClientUserController extends Controller
{
    ...
    public function destroy(string $id): RedirectResponse
    {
        ...
        return redirect()->route('client.retailer-users.index')->with('success', 'Retailer client user deleted successfully.');
    }
}
